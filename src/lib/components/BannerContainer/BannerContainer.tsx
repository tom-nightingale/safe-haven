    ...
    showBanners && (
      ...
      >
        ...
        {banners.map((banner: Banner, index: number) => (
          <div
            key={banner._id}
            className={`absolute top-0 flex w-full items-baseline justify-center gap-4 px-6 py-2 text-center transition-opacity duration-500 ease-in-out ${
