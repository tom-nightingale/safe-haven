...
const HeroCard = ({ title, subtitle, link, colourTheme = "peach" }: Props) => {
  ...
  return (
    <div
      className={`${theme[safeColourTheme].containerClass} relative col-span-10 col-start-2 cursor-pointer rounded-xl p-8 text-white transition-all duration-300 ${colourTheme !== "yellow" ? "sm:col-span-6" : ""} md:col-span-4 lg:col-span-3 xl:py-12`}
    >
