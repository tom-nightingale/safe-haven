...
export type CardListOrHeroOrLocationDetailsOrReviewsCarouselOrStaffCardsOrTextWithImage =
...
export type ContentBlocks = {
  ...
  contentblocks?: Maybe<
    Array<
      Maybe<CardListOrHeroOrLocationDetailsOrReviewsCarouselOrStaffCardsOrTextWithImage>
    >
  >;
};
